...
// Contiguous = boxes are not connected
...
// Garbage value
if we
    print only the first int a[10]; // if we print it out this will give the garbage value to us later
